...
<tbody>
                    <tr>
                        ...
                        <td id="th"><input type="text" name="name" value="" placeholder="Enter your Email id" required/></td>
                    </tr>
                    <tr>
...
<input type="submit" value="Login" class="btn btn-info" role="button"></center>
